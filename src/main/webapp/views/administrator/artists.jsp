			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a href="dashboard/admin/home.do"><i class="fa fa-home"></i> Home</a></li>
								<li><a><i class="fa fa-edit"></i> Users <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
										<li><a href="dashboard/admin/purchasers.do">Purchasers</a></li>
										<li><a href="dashboard/admin/artists.do">Artists</a></li>
									</ul></li>
								<li><a><i class="fa fa-desktop"></i> Artworks <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
										<li><a href="dashboard/admin/onSaleArtworks.do">On Sale</a></li>
										<li><a href="dashboard/admin/soldArtworks.do">Sold</a></li>
									</ul></li>
								<li><a href="dashboard/admin/orders.do"><i class="fa fa-table"></i> Orders <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
									</ul></li>
					...
					<div class="sidebar-footer hidden-small">
						...
						</a> <a href="j_spring_security_logout" data-toggle="tooltip"
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <img
									src="styles/dashboard/images/img.jpg" alt="">John Doe <span
							...
							<li role="presentation" class="dropdown"><a
								...
								<ul id="menu1"
									...
									<li><a> <span class="image"> <img
												src="styles/dashboard/images/img.jpg" alt="Profile Image" />
			...
			<div class="right_col" role="main">
				...
				<div class="row tile_count">
					...
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-user"></i> On Sale
								Artworks</span>
					...
					<div
						...
						<div class="left"></div>
						<div class="right">
							<span class="count_top"><i class="fa fa-user"></i> Solt
								Artworks</span>
							<div class="count">
								<jstl:out value="${totalSoltArtworks}"></jstl:out>
							</div>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message code="admin.dashboard.findMoreArtworksSoldArtists" />
								</h2>
								<ul class="nav navbar-right panel_toolbox">
									<li><a class="collapse-link"><i
											class="fa fa-chevron-up"></i></a></li>
							...
							<div class="x_content">
								...
								<spring:message
									code="admin.dashboard.findNumberMoreArtworksSoldArtists" />
								:
								<jstl:out value="${numberMoreArtworksSoldArtists}"></jstl:out>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									<spring:message code="admin.dashboard.findArtistEarnedMoreMoney" />
								</h2>
								<ul class="nav navbar-right panel_toolbox">
									<li><a class="collapse-link"><i
											class="fa fa-chevron-up"></i></a></li>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<table
									class="table table-bordered responsive-utilities jambo_table bulk_action">
									<thead>
										<tr class="headings">
