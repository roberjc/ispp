					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a href="dashboard/admin/home.do"><i
			...
			<div class="right_col" role="main">
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>All the on sale artworks</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
										...
										<tbody>
											...
											<jstl:forEach items="${onSaleArtworks}" var="artwork">
												<tr>
													...
													<td>${artwork.discipline}</td>
													<td>${artwork.width}</td>
													<td>${artwork.height}</td>
													<td>${artwork.moment}</td>
													<td>${artwork.status}</td>
													<td>${artwork.price}</td>
													<td>${artwork.totalCost}</td>
												</tr>
											</jstl:forEach>
										</tbody>
									</table>
