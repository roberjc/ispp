						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Users <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
										<li><a href="form.html">Purchasers</a></li>
										<li><a href="form_advanced.html">Artists</a></li>
									</ul></li>
								<li><a><i class="fa fa-desktop"></i> Artworks <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
										<li><a href="general_elements.html">On Sale</a></li>
										<li><a href="media_gallery.html">Solt</a></li>
									</ul></li>
